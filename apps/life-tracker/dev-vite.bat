@echo off
REM ============================================================
REM  BookTracker - renderer-only dev mode (vite dev, no cargo)
REM  - No Rust compile, fast startup, for UI-only debugging
REM  - Open http://localhost:1420 in browser to view
...
echo ============================================
echo  BookTracker dev (vite only, no cargo)
echo ============================================
echo  - Vite HMR: frontend changes auto-reload
echo  - Open browser at http://localhost:1420
