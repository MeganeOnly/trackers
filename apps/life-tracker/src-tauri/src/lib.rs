//! life-tracker Tauri entry point.
//!
//! 模块结构:
//! - `types` —— Goal 领域类型(Rust serde 镜像)
//! - `data` —— Goal 文件 I/O + frontmatter 解析
//! - `service` —— 业务逻辑包装
    ...
    pub fn run() {
        tauri::Builder::default()
            ...
            .invoke_handler(tauri::generate_handler![
                ...
                commands::goals_list,
                commands::goals_get,
                commands::goals_create,
                commands::goals_update,
                commands::goals_progress_bump,
